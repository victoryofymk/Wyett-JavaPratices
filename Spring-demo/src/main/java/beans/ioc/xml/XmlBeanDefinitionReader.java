package beans.ioc.xml;

import beans.ioc.AbstractWyattBeanDefinitionReader;
import beans.ioc.BeanReference;
import beans.ioc.PropertyValue;
 ...
 */
public class XmlBeanDefinitionReader extends AbstractWyattBeanDefinitionReader {
    /**
     * 构造器，必须包含一个资源加载器
     *
     * @param resourceLoader 资源加载器
     */
    public XmlBeanDefinitionReader(WyattResourceLoader resourceLoader) {
        super(resourceLoader);
    }

    public void readerXML(String location) throws Exception {
        // 创建一个资源加载器
        WyattResourceLoader resourceloader = new WyattResourceLoader();
        // 从资源加载器中获取输入流
     ...
     */
    private void addPropertyValues(Element ele, WyattBeanDefinition beandefinition) {
