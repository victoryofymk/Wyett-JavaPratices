 ...
 */
public class AutowireWyattBeanFactory extends WyattDefaultBeanFactory {
    /**
     * 根据bean 定义创建实例， 并将实例作为key， bean定义作为value存放，并调用 addPropertyValue 方法 为给定的bean的属性进行注入
     */
    @Override
    protected Object doCreate(WyattBeanDefinition beandefinition) throws Exception {
     ...
     */
    protected void addPropertyValue(Object bean, WyattBeanDefinition beandefinition) throws Exception {
        // 循环给定 bean 的属性集合
