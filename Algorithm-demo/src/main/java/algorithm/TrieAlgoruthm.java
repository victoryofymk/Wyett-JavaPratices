...
/**
 * 字典树优化搜索,插入、查找、遍历、单词联想（找公共前缀）
 * <p>
 * 参考http://qingbob.com/trie/?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io
 *
 * @author yanmingkun
 * @date 2018-11-15 13:40
 */
public class TrieAlgoruthm {
    private class Node {
